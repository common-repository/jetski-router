...
class RouterTest extends \Codeception\Test\Unit{
  ...
  function requestsToDispatchProvider()
  {
    return [
      ...
      'dynamic route with lowercase letters and _ - symbols custom regex param' => [ 
        ...
        'request' => ['routeHttpMethod' => 'PUT', 'routePath' => 'articles/why-jetski_router-is-a-great-tool'],
  ...
  function validReverseRoutesProviderWithNamespace()
  {
    ...
    return [
      'Valid entries' => [
        'routerArgs' => [ 'namespace' => '/jetski-api/v3' ],
        'routes' => [
          [
            'routeHttpMethod' => 'POST',
            'routePath' => 'users',
        ...
        'reverseRoutesOutputs' => [
          '/jetski-api/v3/users/',
          '/jetski-api/v3/users/sformisano/',
          '/jetski-api/v3/users/matt/comments/',
          '/jetski-api/v3/users/james/comments/published/',
          '/jetski-api/v3/users/kris/comments/rejected/3/',
          '/jetski-api/v3/users/kris/comments/2/',
          '/jetski-api/v3/schools/mit/teachers/tony-stark/students/2000/',
          '/jetski-api/v3/schools/caltech/teachers/students/1990/',
          '/jetski-api/v3/schools/politecnico-milano/teachers/students/',
          '/jetski-api/v3/taxonomy/type/tag/'
        ]
      ]
    ];
  }
   ...
   * @expectedException        JETSKI\Router\Exception\InvalidNamespaceException
   ...
   * @expectedException        JETSKI\Router\Exception\InvalidOutputFormatException
   ...
   * @expectedException        JETSKI\Router\Exception\InvalidHttpMethodException
   ...
   * @expectedException        JETSKI\Router\Exception\InvalidRouteException
   ...
   * @expectedException        JETSKI\Router\Exception\InvalidRouteHandlerException
